// Kilden til sannhet for hvilke kategorier og ord som finnes i spillet.
// Redigeres for hånd. Reglene som gjør et brett entydig — unike ord på tvers av
// alle kategorier, nøyaktig WORDS_PER_CATEGORY ord hver, slug som matcher navnet
// og en beskrivelsesbunt som dekker ordene — håndheves av categories-data.test.ts.
// Se README, «Kategoridataene», for hvordan du legger til en kategori.
...
export const CATEGORIES: Category[] = [
  ...
  {
    name: "Europeiske land",
    slug: "europeiske-land",
    words: [
      "Norge",
      "Sverige",
      "Danmark",
  ...
  {
    name: "Mineraler og edelstener",
    slug: "mineraler-og-edelstener",
    words: [
      "diamant",
      "rubin",
      "safir",
  ...
  {
    name: "Nettord og nettkultur",
    slug: "nettord-og-nettkultur",
    words: [
      "profil",
      "avatar",
      "feed",
  ...
  {
    name: "Motorsykkelmerker",
    slug: "motorsykkelmerker",
    words: [
      "Harley-Davidson",
      "Ducati",
      "Kawasaki",
  ...
  {
    name: "Land og territorier i Amerika",
    slug: "land-og-territorier-i-amerika",
    words: [
      "USA",
      "Canada",
      "Mexico",
  ...
  {
    name: "Håndgrep og berøring",
    slug: "handgrep-og-beroring",
    words: [
      "gripe",
      "holde",
      "slippe",
  ...
  {
    name: "Fotografibegreper",
    slug: "fotografibegreper",
    words: [
      "blender",
      "lukkertid",
      "brennvidde",
  ...
  {
    name: "Friluftsliv og turutstyr",
    slug: "friluftsliv-og-turutstyr",
    words: [
      "telt",
      "sovepose",
      "primus",
  ...
  {
    name: "Historiske slag",
    slug: "historiske-slag",
    words: [
      "Marathon",
      "Termopylene",
      "Salamis",
  ...
  {
    name: "Kaffetyper og kaffeutstyr",
    slug: "kaffetyper-og-kaffeutstyr",
    words: [
      "espresso",
      "doppio",
      "ristretto",
  ...
  {
    name: "Landbruk og gårdsdrift",
    slug: "landbruk-og-gardsdrift",
    words: [
      "harv",
      "plog",
      "skurtresker",
  ...
  {
    name: "Norske TV-programmer",
    slug: "norske-tv-programmer",
    words: [
      "Fleksnes",
      "Dagsrevyen",
      "Norge rundt",
  ...
  {
    name: "Skisport og skiutstyr",
    slug: "skisport-og-skiutstyr",
    words: [
      "klister",
      "feller",
      "glid",
  ...
  {
    name: "Skole og utdanning",
    slug: "skole-og-utdanning",
    words: [
      "pensum",
      "lekser",
      "friminutt",

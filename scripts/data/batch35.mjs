...
export default {
  ...
  "Norske barnebok- og TV-figurer": [
    ...
    "Brumlemann", "Petronella", "Bakermester Harepus", "Bestemor Skogmus",
    "Pinky", "Langemann", "Grusomme Gabriel", "Benjamin", "Skalken", "Pysa",
    "Sunniva", "Doktor Proktor", "Bulle", "Lise", "Elias", "Alfons Åberg",
    "Bamse", "Emanuel Desperado", "Rudolf Blodstrupmoen", "Ben Redic Fy Fazan",
    "Frimand Pløsen", "Mysil Bergsprekken", "Kamomilla", "Barberer Sørensen",
    "Trikkefører Syversen", "Max", "Bjarne Betjent", "Kurt", "Lillebror",
    "Bø", "Bæ",
  ],
};
